...
namespace HY_PIP
{
    public partial class MainForm : Form
    {
        ...
        public static modbus_TCP modbus_TCP;
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (GenericOp.temp1 == true)
            {
                this.temperature1.ForeColor = Color.Red;
            }
            else
            {
                this.temperature1.ForeColor = Color.Green;
            }
            temperature3.Text = GenericOp.temperature3.ToString("") + "°C";
            if (GenericOp.temp3 == true)
            {
                this.temperature3.ForeColor = Color.Red;
            }
            else
            {
                this.temperature3.ForeColor = Color.Green;
            }

            temperature41.Text = GenericOp.temperature41.ToString("") + "°C";
            if (GenericOp.temp4 == true)
            {
                this.temperature41.ForeColor = Color.Red;
            }
            else
            {
                this.temperature41.ForeColor = Color.Green;
            }
            temperature51.Text = GenericOp.temperature51.ToString("") + "°C";
            if (GenericOp.temp5 == true)
            {
                this.temperature51.ForeColor = Color.Red;
            }
            else
            {
                this.temperature51.ForeColor = Color.Green;
            }
            temperature61.Text = GenericOp.temperature61.ToString("") + "°C";
            if (GenericOp.temp6 == true)
            {
                this.temperature61.ForeColor = Color.Red;
            }
            else
            {
                this.temperature61.ForeColor = Color.Green;
            }
            temperature71.Text = GenericOp.temperature71.ToString("") + "°C";
            if (GenericOp.temp7 == true)
            {
                this.temperature71.ForeColor = Color.Red;
            }
            else
            {
                this.temperature71.ForeColor = Color.Green;
            }

            temperature10.Text = GenericOp.temperature10.ToString("") + "°C";
            if (GenericOp.temp10 == true)
            {
                this.temperature10.ForeColor = Color.Red;
            }
            else
            {
                this.temperature10.ForeColor = Color.Green;
            }

            temperature111.Text = GenericOp.temperature111.ToString("") + "°C";
            if (GenericOp.temp11 == true)
            {
                this.temperature111.ForeColor = Color.Red;
            }
            else
            {
                this.temperature111.ForeColor = Color.Green;
            }
            temperature121.Text = GenericOp.temperature121.ToString("") + "°C";
            if (GenericOp.temp12 == true)
            {
                this.temperature121.ForeColor = Color.Red;
            }
            else
            {
                this.temperature121.ForeColor = Color.Green;
            }
            // if (GenericOp.AutoMode)
            //{
            //   if (((GenericOp.temp1 * 0.85 > GenericOp.temperature41)) || ((GenericOp.temp2 * 0.85 > GenericOp.temperature51)) || ((GenericOp.temp3 * 0.85 > GenericOp.temperature61)) || ((GenericOp.temp4 * 0.85 > GenericOp.temperature71)) || ((GenericOp.temp5 * 0.85 > GenericOp.temperature111)))
            //  {
            //      GenericOp.tmpTimeOffset = 0;
            //     GenericOp.tempon = true;
            // }
            // else
            // {
            //     GenericOp.tempon = false;
            // }
            //  }
        }
