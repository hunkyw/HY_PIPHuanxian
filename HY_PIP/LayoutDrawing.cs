...
public class LayoutDrawing : DrawingArea
{
    ...
    public static bool drawOnly = false;
    ...
    public LayoutDrawing()
    {
        ...
        logicPoints[11] = loadPoints[hyWorkFlow.POS_IDLE] = new ServoPoint(980, 100);// 空地
        logicPoints[12] = loadPoints[10] = new ServoPoint(954, 156);
    ...
    private void ThreadOpenStoveLid()
    {
        while (true)
        {
            ...
            {
                SerialManual.StopStoveLidCmd(closeStoveLidPos);// 如果在龙门附近关闭盖子，就停止所有盖子的动作。
            }
    ...
    protected override void OnDraw()
    {
        ...
        DrawText(text, "Calibri", fontSize
            , FontStyle.Italic, Brushes.White, textPosition);
    ...
    private int PointsMap(int x, int x0, int x1, int y0, int y1)
    {
